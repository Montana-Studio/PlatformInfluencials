<?php
	...
	$titulo_facebook=strtoupper("resultados facebook");
	$titulo_instagram=strtoupper("resultados instagram");
	$titulo_twitter=strtoupper("resultados twitter");
	$titulo_youtube=strtoupper("resultados youtube");
