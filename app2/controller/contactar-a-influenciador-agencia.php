...
unset($agencia);
unset($correo_agencia);
unset($influenciador);
unset($influenciador_id);
unset($id_campana);
unset($id_agencia);
unset($query_correo_influenciador);
unset($result_correo_influenciador);
unset($row_correo_influenciador);
unset($correo_influenciador);
unset($query_nombre_influenciador);
unset($result_nombre_influenciador);
unset($row_nombre_influenciador);
unset($num_row_nombre_influenciador);
unset($campana);
unset($asunto);
unset($mensaje);
unset($results);
