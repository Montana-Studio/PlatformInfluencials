...
$mysqli->set_charset('utf8_bin');
	...
	ini_set('session.cookie_lifetime', 60*60*4); //too keep ir by one year use 60*60*24*365
	ini_set('session.gc-maxlifetime', 60*60*4);
	if (isset($_SESSION['LAST_ACTIVITY']) && (time() - $_SESSION['LAST_ACTIVITY'] > 60*60*4)) {
