<?php include 'header-ipe.php';?>
	...
	<form class="cont_formRegistro contFroms">
		<div class="cont-inputs">
			<h2 class="sub-title">formulario de ingreso</h2>
			<p>Rellena los campos para tener un perfil más completo de ti, estos campos serán necesarios para comercializar tus datos con las campañas</p>
			<div class="selects">
				<small>Perfil</small>
