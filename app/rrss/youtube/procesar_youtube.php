...
$results2 = $mysqli->query('SELECT rrss_id FROM rrss WHERE rrss_id="'.$youtubeId.'" AND descripcion_rrss="youtube"');
$num_row2=mysqli_num_rows($results2);

if($num_row1 < 1 && $num_row2 < 1){
	$results2 = $mysqli->query('INSERT INTO rrss (descripcion_rrss,rrss_id,persona_id, cuenta) VALUES ("youtube","'.$youtubeId.'","'.$id_persona.'", "1")');
	echo 'exito';
}
