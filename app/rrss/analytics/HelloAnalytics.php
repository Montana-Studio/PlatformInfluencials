...
$client->setAuthConfig('key-nibaldo.p12');
...
function getService()
{
  ...
  // Use the developers console and replace the values with your
  // service account email, and relative location of your key file.
  $service_account_email = '045210216843-cefe3gbi031hpdrrgihdocpfr79qgqjr@developer.gserviceaccount.com';
  $key_file_location = file_get_contents('key-nibaldo.p12');
