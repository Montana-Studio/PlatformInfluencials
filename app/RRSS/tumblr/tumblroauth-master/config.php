<?php
	...
	defined('SITE_URL')  ? null : define('SITE_URL',  'http://local.mediatrends/PlatformInfluencials/app/Instagram/tumblr/tumblroauth-master');
	
	// define database credentials
	defined('DB_HOST') ? null : define('DB_HOST', 'localhost');
	defined('DB_USER') ? null : define('DB_USER', 'root');
	defined('DB_PASS') ? null : define('DB_PASS', 'root');
	defined('DB_NAME') ? null : define('DB_NAME', 'users_oauth');
	...
	defined('TUMBLR_OAUTH_KEY')      ? null : define('TUMBLR_OAUTH_KEY', 'rBhMVQ34NTiKVNZpXdEe5fCiS4EGfsnSXngZZD6JJrM2L4LtnQ');
	defined('TUMBLR_OAUTH_SECRET')   ? null : define('TUMBLR_OAUTH_SECRET', 'LmqmeCjYqTEQdVXPRY2w1YLhywov7K2FWdG6PZ4spTWWN0FKLj');
