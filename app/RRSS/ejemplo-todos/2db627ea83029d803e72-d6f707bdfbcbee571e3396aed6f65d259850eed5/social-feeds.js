...
'use strict';
    ...
    $(function () {
        ...
        $.getJSON('https://www.googleapis.com/youtube/v3/channels?part=statistics&forUsername='+youtubeUser+'&fields=items/statistics/subscriberCount&key=AIzaSyC7WF2_-G6XOXXAt8bNyBCDStnfbi1JvYI', function(data) {
            // views count
