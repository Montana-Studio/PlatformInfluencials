...
if($_POST['tipo']=='perfil_publico'){
    ...
    $correo_influenciador=$num_row_correo_influenciador[0];
    ...
    if($num_row_nombre_influenciador>0){
    	if($id_campana=='sin_especificar'){
			...
			$results = $mysqli->query("INSERT INTO solicitudes (agencia, correo_agencia, influenciador , correo_influenciador, id_influenciador, id_agencia, fecha_solicitud, id_campana, campana )VALUES ('$agencia', '$correo_agencia','$influenciador', '$row_correo_influenciador[0]', '$influenciador_id', '$id_agencia', '$hoy' , '$id_campana', '$campana' )");
			echo 'exito';
		}else{
