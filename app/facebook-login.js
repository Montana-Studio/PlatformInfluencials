...
$(document).ready(function(){
	...
	var facebookLogin= function (){
		...
		checkLoginState(function(response){
			...
			if( navigator.userAgent.match('CriOS') ){
   			 window.open('https://www.facebook.com/dialog/oauth?client_id='+app_id+'&scope='+scopes+'&redirect_uri=http://www.powerinfluencer.com/mt_prod/formulario-agencia', "_self");
   			 getFacebookData();
			}else{
	...
	var facebookPages= function (){
		...
		checkLoginState(function(response){
			if(!response){ //no esta conectado callback false
			if( navigator.userAgent.match('CriOS') ){
   			 window.open('https://www.facebook.com/dialog/oauth?client_id='+app_id+'&scope='+scopes+'&redirect_uri=http://www.powerinfluencer.com/mt_prod/', "_self");
   			 getFacebookPages();
			}else{
					FB.login(function (response){
				if (response.status === 'connected')
