...
if($num_rows_url>0){
	...
	unset($getfield1);
    unset($twitter1);
    unset($twitter_post_id_query);
    unset($data1);
    unset($twitter_post_id);
	unset($result_url);
	unset($cantidad_de_posts_googleplus);
	unset($valida_url);
	unset($result_compare_rrss_id_with_url);
	unset($num_row_compare_rrss_id_with_url);
	unset($facebook_post_id_array);
	unset($string_facebook_post_id);
	unset($json_user_url1);
	unset($facebook_post_owner);
