...
function requiere_actualizar($persona_id){
    ...
    if($num_row_no_laboral>0){
        ...
        if($num_row_actualizado>0){
            ...
            if($num_row_no_actualizado>0){
                $query_actualiza_datos1="UPDATE session_table SET renovado='1' WHERE persona_id='".$persona_id."'";
                $result_actualiza_datos=mysqli_query($mysqli,$query_actualiza_datos1)or die (mysqli_error());
                return 1;
            }else{
